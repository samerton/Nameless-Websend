...
class Websend_Module extends Module {
	...
	public function __construct($pages, $language, $websend_language, $queries, $cache){
		...
		$name = 'Websend';
		$author = '<a href="https://samerton.me" target="_blank" rel="nofollow noopener">Samerton</a> and <a href="https://github.com/supercrafter100" target="_blank" rel="nofollow noopener">Supercrafter100</a>';
