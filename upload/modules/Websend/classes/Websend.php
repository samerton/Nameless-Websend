<?php
/*
 *  Written by Waterflames for the Websend project (MIT License: https://github.com/Wouterdek/Websend/blob/master/README)
...
class Websend
{
	...
	private $password = "";/* Password in Websend server config */
